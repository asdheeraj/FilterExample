...
class FiltersAdapter(private val filters: ArrayList<String>, private val listener: FilterClickListener) : RecyclerView.Adapter<DataViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DataViewHolder =
        DataViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_filter, parent, false))
    ...
    override fun onBindViewHolder(holder: DataViewHolder, position: Int) {
        ...
        holder.itemView.apply {
            tv_filter_option.setOnClickListener {
                ...
                if(it.isSelected) {
                    it.background = holder.itemView.context.getDrawable(R.drawable.ic_rounded_rectangle_selected)
                    tv_filter_option.setTextColor(ContextCompat.getColor(this.context,R.color.white))
                } else {
                    it.background = holder.itemView.context.getDrawable(R.drawable.ic_rounded_rectangle_unselected)
